 ...
 */
package org.cagrid.wsrf.properties;
...
public interface ResourceProperty<T> {
	...
	/**
	 * Converts the resource property value into a SOAPElement array. Each value
	 * is wrapped into an element named after the resource property. If the RP
	 * has no values (is null), and RP element was defined as:
	 * <ul>
	...
	/**
	 * Converts the resource property value into a DOM Element array. Each value
	 * is wrapped into an element named after the resource property. If the RP
	 * has no values (is null), and RP element was defined as:
	 * <ul>
	 * <li>minOccurs >= 0 - the function returns null.</li>
